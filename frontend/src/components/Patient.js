...
export default function PatientDashboard() {
  ...
  const fetchPatientProfile = async () => {
    try {
      ...
      const response = await fetch('https://hospital-management-seven-lake.vercel.app/api/patient/profile', {
        headers: {
  ...
  const fetchDoctors = async () => {
    try {
      ...
      const response = await fetch('https://hospital-management-seven-lake.vercel.app/api/doctor/all', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const fetchAvailableSlots = async (doctorId, date) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`https://hospital-management-seven-lake.vercel.app/api/patient/available-slots?doctorId=${doctorId}&date=${date}`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const fetchAppointments = async () => {
    try {
      ...
      const response = await fetch('https://hospital-management-seven-lake.vercel.app/api/patient/appointments', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const fetchCareTeam = async () => {
    try {
      ...
      const response = await fetch('https://hospital-management-seven-lake.vercel.app/api/patient/care-team', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const fetchPrescriptions = async () => {
    try {
      ...
      const response = await fetch('https://hospital-management-seven-lake.vercel.app/api/patient/prescriptions', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const renderAppointmentBooking = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const token = localStorage.getItem('token');
        const response = await fetch('https://hospital-management-seven-lake.vercel.app/api/patient/book-appointment', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
